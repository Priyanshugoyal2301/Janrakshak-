...
import { GraduationCap, BookOpen, Award, Clock, Play, CheckCircle } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { 
                  ...
                  level: "Beginner",
                  status: "Available",
                  description: "Learn basic first aid and emergency response techniques"
                },
                { 
                  ...
                  level: "Intermediate",
                  status: "In Progress",
                  description: "Comprehensive disaster response and management training"
                },
                { 
                  ...
                  level: "Advanced",
                  status: "Available",
                  description: "Leadership and coordination skills for community response"
                },
                { 
                  ...
                  level: "Intermediate",
                  status: "Available",
                  description: "Providing psychological first aid to disaster victims"
                }
              ].map((course, index) => (
                <div key={index} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      course.status === 'Available' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                    }`}>
                      {course.status}
                    </span>
                  </div>
