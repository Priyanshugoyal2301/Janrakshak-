        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50">
                Manage Users
              </button>
              <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50">
                Review Reports
