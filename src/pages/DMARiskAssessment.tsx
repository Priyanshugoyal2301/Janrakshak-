    ...
    <NDMALayout>
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">DMA Risk Assessment</h1>
            <p className="text-gray-600 mt-1">Comprehensive risk analysis and vulnerability assessment</p>
          </div>
          <Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-orange-600">Overall Score</p>
          ...
          <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-600">Vulnerability Index</p>
          ...
          <Card className="border-green-200 bg-gradient-to-br from-green-50 to-green-100">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-green-600">Preparedness</p>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  { category: "Cyclone Risk", level: "Medium", color: "yellow" },
                  { category: "Fire Risk", level: "Low", color: "green" }
                ].map((risk, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded">
                    <span className="font-medium">{risk.category}</span>
                    <span className={`px-2 py-1 rounded text-sm font-medium text-${risk.color}-800 bg-${risk.color}-100`}>
                      {risk.level}
                    </span>
                  </div>
                ))}
