...
export class FloodPredictionService {
  ...
  constructor() {
    this.apiBaseUrl = import.meta.env.VITE_BACKEND_URL || 'https://janrakshak-pre-alert-model.onrender.com';
    this.windyApiKey = import.meta.env.WINDY_API || 'g2m3HcyH0yVSaf54Naep9RPvE88hJXQl';
    console.log('🚀 FloodPredictionService initialized with API URL:', this.apiBaseUrl);
  }
