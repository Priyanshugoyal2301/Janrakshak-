...
export const comprehensiveIndianStatesDistricts = {
  'Andhra Pradesh': [
...
export const getDistrictsForState = (state: string): string[] => {
  return comprehensiveIndianStatesDistricts[state as keyof typeof comprehensiveIndianStatesDistricts] || [];
};

// Get all states
export const getAllStates = (): string[] => {
  return Object.keys(comprehensiveIndianStatesDistricts).sort();
};

// Get all districts
export const getAllDistricts = (): string[] => {
  return Object.values(comprehensiveIndianStatesDistricts).flat().sort();
};